...
from utils import (
    ...
    measure_distance, get_center_of_bbox, 
...
class MiniCourt():
    ...
    def draw_brackground_rectangle(self, frame):
    ...
    def draw_mini_court(self, frames):
        output_frames = []
        for frame in frames:
            frame = self.draw_brackground_rectangle(frame)
    ...
    def convert_bbox_to_mini_court_coords(self, player_boxes, ball_boxes, original_court_key_points):
        player_heights = {
